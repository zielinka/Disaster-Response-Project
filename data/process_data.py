...
def load_data(messages_filepath, categories_filepath):
    ...
    Parameters: 
    messages_filepath (string) - messages dataset file path, 
    categories_filepath (string) - categories dataset file path
                    
    Returns:
    df (dataframe) - dataframe of merged datasets
    '''
...
def save_data(df, database_filename):
    ...
    '''
    Save cleaned dataset as a sqlite database 
