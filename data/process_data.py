...
def load_data(messages_filepath, categories_filepath):
    ...
    - merge both datasets (messages and categories) based on id
...
def clean_data(df):
    ...
    Function to clean data:
       - split the categories column into separate (based on ; character)
       - Create column names for created categories data (clearly named columns)
