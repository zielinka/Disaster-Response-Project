...
def load_data(database_filepath):
    ...
    '''
     - Looad data from the SQLite database
...
def evaluate_model(model, X_test, Y_test, category_names):
    ...
    - Predict target Y based on X_test set
    - Display results: report f1 score, precision and recall for each category of the dataset 
